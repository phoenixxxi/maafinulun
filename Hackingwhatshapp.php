<?php 
	echo "\e[93emName : Yuan Sandra\n\n";
	echo "\e[93emNik : 16630342\n\n";
	echo "\e[93emUniversitas : Uniska Banjarmasin\n\n";
	echo "\e[93emJurusan : Teknik Informatika\n\n";
echo "\e[93emNomor Target?\nInput : ";
